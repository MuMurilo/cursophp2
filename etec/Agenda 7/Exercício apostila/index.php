...
<body class="w3-black">
    ...
    <div class="w3-container w3-col w3-row w3-center ">
        ...
        <div class="w3-col w3-button w3-deep-purple w3-cell w3-round-large w3-marginright" style="width:23%;">
            <a href="listar.php" style="text-decoration: none;">
                <i class=" fa fa-arrow-rotate-right" style="font-size: 10.5em"></i>
